...
p1 <- ggplot(d,aes(x,y1))+geom_point(color="blue")+ylab("PDF f(x)")
p2 <- ggplot(d,aes(x,y2))+geom_point(color="red")+ylab("CDF F(x)")
p3 <- ggplot(d,aes(x,y3))+geom_point(color="blue")+ylab("PDF f(x)")
p4 <- ggplot(d,aes(x,y4))+geom_point(color="red")+ylab("CDF F(x)")
